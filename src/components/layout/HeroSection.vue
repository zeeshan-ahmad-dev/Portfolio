<template>
  <section
    class="bg-[#050505] mt-[60px] border-[1px] border-[#ffffff0b] text-white flex lg:grid lg:grid-cols-2 lg:place-items-center md:px-20 md:py-6 lg:py-20 flex-col-reverse items-center"
  >
    ...
    <div class="px-6 mt-10 text-center lg:text-left">
      ...
      <p class="my-4">
        I'm Zeeshan Ahmad, a self-taught Full Stack Developer skilled in Vue.js,
        React, Node.js, Express, MongoDB, Tailwind CSS, and more. I create
        responsive, dynamic web applications and enjoy turning ideas into real
        projects that solve problems. I also help clients convert their Figma or
        other designs into fully functional websites.
      </p>
